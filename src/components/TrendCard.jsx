...
export const TrendCard = ({ header, image }) => {
  return (
    <div className="flex w-[293px] h-[320px] flex-col gap-4 justify-end items-center rounded-xl overflow-hidden bg-black">
      <img src={image} alt="" className="h-[320px] shrink-0 opacity-70" />
